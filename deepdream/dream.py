...
net_fn   = model_path + 'deploy.prototxt' #rename these for simplicity after downloading them
param_fn = model_path + 'train_model.caffemodel' #rename these for simplicity after downloading them
